...
\newcommand{\F}{\ensuremath{\mathop{\mathbb{F}}}}
...
\newcommand{\urep}[1]{\ensuremath{U_{#1}}}
\newcommand{\summe}[3]{\ensuremath{\sum\limits_{#1=#2}^{#3}}}
\newcommand{\biguniondisjoint}{\ensuremath{\mathop{\accentset{\bullet}{\bigcup}}
}}
\newcommand{\Autos}[1]{\ensuremath{\mathrm{Aut}(#1)}}
\newcommand{\Endos}[1]{\ensuremath{\mathrm{End}(#1)}}
